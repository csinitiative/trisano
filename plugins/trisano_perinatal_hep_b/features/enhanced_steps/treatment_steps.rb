def add_p_hep_b_treatment(treatment, days_ago, index_string="1st")
  ...
  @browser.select("xpath=//div[@id='treatments']//div[@class='treatment'][#{index}]//select[contains(@name, 'yn')]", "Yes")
  @browser.select("xpath=//div[@id='treatments']//div[@class='treatment'][#{index}]//select[contains(@name, 'treatment_id')]", treatment)
  @browser.type("xpath=//div[@id='treatments']//div[@class='treatment'][#{index}]//input[contains(@name, 'treatment_date')]", (Date.today - days_ago.to_i.days).to_s)

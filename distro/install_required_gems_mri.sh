...
sudo gem install --no-ri --no-rdoc --ignore-dependencies $GEM_DIR/nokogiri-1.3.3.gem
...
sudo gem install --no-ri --no-rdoc --ignore-dependencies $GEM_DIR/rack-1.0.0.gem
sudo gem install --no-ri --no-rdoc --ignore-dependencies $GEM_DIR/rails-2.3.4.gem
sudo gem install --no-ri --no-rdoc --ignore-dependencies $GEM_DIR/activesupport-2.3.4.gem
sudo gem install --no-ri --no-rdoc --ignore-dependencies $GEM_DIR/activeresource-2.3.4.gem
sudo gem install --no-ri --no-rdoc --ignore-dependencies $GEM_DIR/activerecord-2.3.4.gem
sudo gem install --no-ri --no-rdoc --ignore-dependencies $GEM_DIR/actionpack-2.3.4.gem
sudo gem install --no-ri --no-rdoc --ignore-dependencies $GEM_DIR/actionmailer-2.3.4.gem

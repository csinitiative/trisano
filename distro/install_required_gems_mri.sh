...
$command gem install --no-ri --no-rdoc --ignore-dependencies $GEM_DIR/warbler-0.9.14.gem
$command gem install --no-ri --no-rdoc --ignore-dependencies $GEM_DIR/flexmock-0.8.3.gem
$command gem install --no-ri --no-rdoc --ignore-dependencies $GEM_DIR/lockfile-1.4.3.gem
$command gem install --no-ri --no-rdoc --ignore-dependencies $GEM_DIR/logging-1.3.0.gem
$command gem install --no-ri --no-rdoc --ignore-dependencies $GEM_DIR/little-plugger-1.1.1.gem
$command gem install --no-ri --no-rdoc --ignore-dependencies $GEM_DIR/json_pure-1.1.3.gem
$command gem install --no-ri --no-rdoc --ignore-dependencies $GEM_DIR/rubyzip-0.9.1.gem
$command gem install --no-ri --no-rdoc --ignore-dependencies $GEM_DIR/mislav-will_paginate-2.3.6.gem
$command gem install --no-ri --no-rdoc --ignore-dependencies $GEM_DIR/rspec-1.2.8.gem
$command gem install --no-ri --no-rdoc --ignore-dependencies $GEM_DIR/rspec-rails-1.2.7.1.gem
$command gem install --no-ri --no-rdoc --ignore-dependencies $GEM_DIR/haml-2.0.7.gem
$command gem install --no-ri --no-rdoc --ignore-dependencies $GEM_DIR/rack-1.0.1.gem
$command gem install --no-ri --no-rdoc --ignore-dependencies $GEM_DIR/rails-2.3.5.gem
$command gem install --no-ri --no-rdoc --ignore-dependencies $GEM_DIR/activesupport-2.3.5.gem
$command gem install --no-ri --no-rdoc --ignore-dependencies $GEM_DIR/activeresource-2.3.5.gem
$command gem install --no-ri --no-rdoc --ignore-dependencies $GEM_DIR/activerecord-2.3.5.gem
$command gem install --no-ri --no-rdoc --ignore-dependencies $GEM_DIR/actionpack-2.3.5.gem

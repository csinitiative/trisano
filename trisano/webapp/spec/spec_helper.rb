...
def mock_event
  ...
  event.stub!(:contacts).and_return([contact])
  ...
  event.stub!(:udoh_case_status).and_return(udoh_case_status)
...
def mock_person_entity
  ...
  location.stub!(:telephones).and_return([phone])
  location.stub!(:addresses).and_return([address])

  address_entities_location = mock_model(EntitiesLocation)
  address_entities_location.stub!(:entity_id).and_return("1")
  address_entities_location.stub!(:entity_location_type_id).and_return("1302")
  address_entities_location.stub!(:primary_yn_id).and_return("1402")
  address_entities_location.stub!(:location_type_id).and_return("2311")
  address_entities_location.stub!(:location).and_return(location)
  
  telephone_entities_location = mock_model(EntitiesLocation)
  telephone_entities_location.stub!(:entity_id).and_return("1")
  telephone_entities_location.stub!(:entity_location_type_id).and_return("2106")
  telephone_entities_location.stub!(:primary_yn_id).and_return("1401")
  telephone_entities_location.stub!(:location_type_id).and_return("2312")
  telephone_entities_location.stub!(:location).and_return(location)

  entity = mock_model(Entity, :to_param => '1')
  entity.stub!(:entity_type).and_return('person')
  entity.stub!(:person).and_return(person)
  entity.stub!(:address_entities_locations).and_return([address_entities_location])

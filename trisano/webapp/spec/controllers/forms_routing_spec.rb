...
describe FormsController do
  describe "route generation" do
    ...
    it "should map { :controller => 'forms', :action => 'rollback', :id => 1} to /forms/rollback/1" do
      route_for(:controller => "forms", :action => "rollback", :id => 1).should == "/forms/rollback/1"
    end
    ...
    it "should map { :controller => 'forms', :action => 'import'} to /forms/import" do
      route_for(:controller => "forms", :action => "import").should == "/forms/import"
    end
    
    it "should map { :controller => 'forms', :action => 'push', :id => 1} to /forms/1/push" do
  ...
  describe "route recognition" do
    ...
    it "should generate params { :controller => 'forms', action => 'rollback', id => '1' } from GET /forms/rollback/1" do
      params_from(:get, "/forms/rollback/1").should == {:controller => "forms", :action => "rollback", :id => "1"}
    end
    ...
    it "should generate params { :controller => 'forms', action => 'import', id => '1' } from POST /forms/import" do
      params_from(:post, "/forms/import").should == {:controller => "forms", :action => "import"}
    end
    
    it "should generate params { :controller => 'forms', action => 'push', id => '1' } from POST /forms/1/push" do

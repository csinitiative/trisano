...
module NedssHelper
  ...
  def get_full_cmr_hash()
    @cmr_fields = {
      ...
      "morbidity_event_active_patient__active_primary_entity__telephone_area_code" => "801",
      "morbidity_event_active_patient__active_primary_entity__telephone_phone_number" => "555-7894",
      "morbidity_event_active_patient__active_primary_entity__telephone_extension" => "147",

...
#  $dont_kill_browser = true
  ...
  fields = [{:name => 'Contact last name', :label => 'contact_event_active_patient__person_last_name', :entry_type => 'type', :fu_value => get_unique_name(1), :no_fu_value => get_unique_name(1)},
    {:name => 'Contact first name', :label => 'contact_event_active_patient__person_first_name', :entry_type => 'type',  :fu_value => get_unique_name(1), :no_fu_value => get_unique_name(1)},
    {:name => 'Contact middle name', :label => 'contact_event_active_patient__person_middle_name', :entry_type => 'type',  :fu_value => get_unique_name(1), :no_fu_value => get_unique_name(1)},
    {:name => 'Contact age', :label => 'contact_event_active_patient__person_approximate_age_no_birthday', :entry_type => 'type', :fu_value => '24', :no_fu_value => '44'},
    {:name => 'Contact birth gender', :label => 'contact_event_active_patient__person_birth_gender_id', :entry_type => 'select', :code => 'Code: Female (gender)', :fu_value => 'Female', :no_fu_value => 'Male'},
    {:name => 'Contact ethnicity', :label => 'contact_event_active_patient__person_ethnicity_id', :entry_type => 'select', :code => 'Code: Hispanic or Latino (ethnicity)', :fu_value => 'Hispanic or Latino', :no_fu_value => 'Not Hispanic or Latino'},
    {:name => 'Contact primary language', :label => 'contact_event_active_patient__person_primary_language_id', :entry_type => 'select', :code => 'Code: English (language)', :fu_value => 'English', :no_fu_value => 'Japanese'}
  ]                                                  

...
describe 'form builder core event level core field configs for contacts' do
  ...
  fields = [#{:name => 'Reporter first name', :label => 'morbidity_event_active_reporter__active_secondary_entity__person_first_name', :entry_type => 'type',:fu_value => get_unique_name(1), :no_fu_value => get_unique_name(1)},
    {:name => 'Reporter last name', :label => 'morbidity_event_active_reporter__active_secondary_entity__person_last_name', :entry_type => 'type',  :fu_value => get_unique_name(1), :no_fu_value => get_unique_name(1)},
#    {:name => 'Reporter phone type', :label => 'morbidity_event_active_reporter__active_secondary_entity__telephone_extension', :entry_type => 'select', :code => 'Code: Mobile (telephonelocationtype)', :fu_value => 'Mobile', :no_fu_value => 'Work'},
#    {:name => 'Reporter area code', :label => 'morbidity_event_active_reporter__active_secondary_entity__telephone_area_code', :entry_type => 'type',:fu_value => '874', :no_fu_value => '878'},
#    {:name => 'Reporter phone number', :label => 'morbidity_event_active_reporter__active_secondary_entity__telephone_phone_number', :entry_type => 'type',:fu_value => '555-8777', :no_fu_value => '555-8998'},
#    {:name => 'Reporter extension', :label => 'morbidity_event_active_reporter__active_secondary_entity__telephone_extension', :entry_type => 'type',:fu_value => '33', :no_fu_value => '32'}
  ]                                                  

...
describe 'form builder place core field configs for places' do
  ...
  fields = [{:name => 'Name', :label => 'place_event_active_place__active_primary_entity__place_name', :entry_type => 'type', :fu_value => 'Shantytown', :no_fu_value => 'Shantyville'},
    {:name => 'Street number', :label => 'place_event_active_place__active_primary_entity__address_street_number', :entry_type => 'type', :fu_value => '444', :no_fu_value => '222'},
    {:name => 'Street name', :label => 'place_event_active_place__active_primary_entity__address_street_name', :entry_type => 'type', :fu_value => 'Chaff Drive', :no_fu_value => 'Chart Drive'},
    {:name => 'Unit number', :label => 'place_event_active_place__active_primary_entity__address_unit_number', :entry_type => 'type', :fu_value => '444', :no_fu_value => '222'},
    {:name => 'City', :label => 'place_event_active_place__active_primary_entity__address_city', :entry_type => 'type', :fu_value => 'Brigham City', :no_fu_value => 'Provo'},
    {:name => 'State', :label => 'place_event_active_place__active_primary_entity__address_state_id', :entry_type => 'select', :code => 'Code: Utah (state)', :fu_value => 'Utah', :no_fu_value => 'Texas'},
    {:name => 'County', :label => 'place_event_active_place__active_primary_entity__address_county_id', :entry_type => 'select', :code => 'Code: Utah (county)', :fu_value => 'Utah', :no_fu_value => 'Davis'},
    {:name => 'Zip code', :label => 'place_event_active_place__active_primary_entity__address_postal_code', :entry_type => 'type', :fu_value => '89011', :no_fu_value => '80001'}
  ]                                    
  ...
  fields.each do |test|  
    ...
    it "should create a cmr with a place" do
      ...
      add_place(@browser, {:name => get_unique_name(1)})

...
sudo gem install --no-ri --no-rdoc --ignore-dependencies $GEM_DIR/activesupport-2.0.2.gem
sudo gem install --no-ri --no-rdoc --ignore-dependencies $GEM_DIR/actionpack-2.0.2.gem
sudo gem install --no-ri --no-rdoc --ignore-dependencies $GEM_DIR/activeresource-2.0.2.gem
sudo gem install --no-ri --no-rdoc --ignore-dependencies $GEM_DIR/actionmailer-2.0.2.gem
sudo gem install --no-ri --no-rdoc --ignore-dependencies $GEM_DIR/activerecord-2.0.2.gem
sudo gem install --no-ri --no-rdoc --ignore-dependencies $GEM_DIR/rails-2.0.2.gem
...
sudo gem install --no-ri --no-rdoc --ignore-dependencies $GEM_DIR/warbler-0.9.11.gem

Feature: Web API Cmrs Client
  ...
  Scenario: Create CMR
    ...
    #And I fill out the form field "morbidity_event[labs_attributes][0][place_entity_attributes][place_attributes][name]" with "Acme Lab"
    #And I fill out the form field "morbidity_event[labs_attributes][0][lab_results_attributes][0][test_type_id]" with ""
    #And I fill out the form field "morbidity_event[labs_attributes][0][lab_results_attributes][0][test_result_id]" with ""
    #And I fill out the form field "morbidity_event[labs_attributes][0][lab_results_attributes][0][result_value]" with "123"
    #And I fill out the form field "morbidity_event[labs_attributes][0][lab_results_attributes][0][units]" with "grams"
    #And I fill out the form field "morbidity_event[labs_attributes][0][lab_results_attributes][0][reference_range]" with "12-88"
    #And I fill out the form field "morbidity_event[labs_attributes][0][lab_results_attributes][0][test_status_id]" with ""
    #And I fill out the form field "morbidity_event[labs_attributes][0][lab_results_attributes][0][specimen_source_id]" with ""
    #And I fill out the form field "morbidity_event[labs_attributes][0][lab_results_attributes][0][collection_date]" with "1-9-2000"
    #And I fill out the form field "morbidity_event[labs_attributes][0][lab_results_attributes][0][lab_test_date]" with "1-10-2000"
    #And I fill out the form field "morbidity_event[labs_attributes][0][lab_results_attributes][0][specimen_sent_to_state_id]" with ""
    #And I fill out the form field "morbidity_event[labs_attributes][0][lab_results_attributes][0][comment]" with "Sample comment"

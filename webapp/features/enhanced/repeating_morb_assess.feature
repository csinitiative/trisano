Feature: Form fields for repeating core sections.
  ...
  Scenario: All repeaters are availble.
    Given   a assessment event with with a morbidity and assessment event form with repeating core fields 
  ...
  Scenario: Empty repeaters are ignored.
    Given   a morbidity event with with a morbidity and assessment event form with repeating core fields 

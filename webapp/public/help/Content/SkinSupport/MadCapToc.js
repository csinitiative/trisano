...
function SetSelection( aNode )
{
    ...
    gCurrSelection.style.backgroundColor = "#d3d3d3";
}
...
function BuildToc( xmlNode, htmlNode, indent , fullPath )
{
    for ( var i = 0; i < xmlNode.childNodes.length; i++ )
    {
        ...
        // NOTE: TOC indentation expanded by CSI.  Try and keep this from being overwritten if MadCap Flare upgraded
        // div.style.textIndent = indent + "px"
        div.style.textIndent = indent + 7 + "px"

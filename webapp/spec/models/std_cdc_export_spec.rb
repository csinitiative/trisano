...
describe CdcExport do
  def create_cdc_event
    ...
    a = Factory(:answer)
    a.question = questions(:std_group_neuro)
    a.text_answer = export_conversion_values(:neuro_confirmed).value_from
    a.save!
    event.answers << a
    a = Factory(:answer)
    a.question = questions(:std_group_detected)
    a.text_answer = export_conversion_values(:detected_provider).value_from
    a.save!
    event.answers << a
    a = Factory(:answer)
    a.question = questions(:std_group_infosrce)
    a.export_conversion_value = export_conversion_values(:infosrce_hiv_counceling)
    a.save!
    event.answers << a
  ...
  describe 'test STD CdcRecord methods' do
    fixtures :events, :disease_events, :diseases, :questions, :cdc_disease_export_statuses, :common_test_types, :export_columns, :export_conversion_values, :entities, :addresses, :people_races, :places, :places_types
  ...
  describe 'running cdc export' do
    fixtures :events, :disease_events, :diseases, :questions, :form_elements, :cdc_disease_export_statuses, :export_columns, :export_conversion_values, :entities, :addresses, :people_races, :places, :places_types, :common_test_types

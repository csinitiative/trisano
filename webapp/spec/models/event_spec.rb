...
describe Event do
  ...
  describe 'export_eventdate calculation' do
    before do
      class HumanEvent
    ...
    it 'should pick the earliest lab_test_date' do
      ...
      event.lab_collection_dates =  " "
      assert_equal("120501", event.export_eventdate)
    end

     it 'should pick the earliest lab_collection_date' do
      event = HumanEvent.new
      event.lab_collection_dates =  " 2012-05-03,2012-05-01,2012-05-05 "
      event.lab_test_dates =  " 2012-04-28 "
      assert_equal("120501", event.export_eventdate)
     end
    ...
    it 'should pick disease_onset_date if present' do
      ...
      event.lab_collection_dates =  " 2012-05-03,2012-05-01,2012-05-05 "
      event.lab_test_dates =  " 2012-04-28 "
      event.disease_onset_date = "2012-05-15"
      assert_equal("120515", event.export_eventdate)
    end
     ...
     it 'should pick disease_event_date_diagnosed if present' do
      ...
      event.lab_collection_dates =  " 2012-05-03,2012-05-01,2012-05-05 "
      event.lab_test_dates =  " 2012-04-28 "
      event.disease_event_date_diagnosed = "2012-05-15"
      assert_equal("120515", event.export_eventdate)
     end
     ...
     it 'should pick first_reported_ph_date over event created date' do
      event = HumanEvent.new
      event.lab_collection_dates =  " "
      event.lab_test_dates =  " "
      event.first_reported_ph_date = "2012-05-04"
      assert_equal("120504", event.export_eventdate)
     end
    ...
    it 'should pick event_created_at date if nothing present' do
      ...
      event.lab_collection_dates =  " "
      event.lab_test_dates =  " "
      event.event_created_at = "2012-04-28"
      assert_equal("120428", event.export_eventdate)
    end

    it 'should fallback to constant if nothing present' do
      event = HumanEvent.new
      event.lab_collection_dates =  " "
      event.lab_test_dates =  " "
      assert_equal("999999", event.export_eventdate)
    end
  end
end

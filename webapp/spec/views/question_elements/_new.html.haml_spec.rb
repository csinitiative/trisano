...
describe "/question_elements/_new.html.haml" do
  ...
  before do
    ...
    assigns[:question_element] = @question_element

    assigns[:export_columns] = [Factory.create(:export_column)]
    assigns[:library_elements] = []
  end

  it "renders" do
    render "question_elements/_new.html.haml"
  end

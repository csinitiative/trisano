...
describe "/value_set_elements/toggle_value.rjs" do
  ...
  before do
    ...
    @value = Factory.build(:value_element, :parent_element_id => @value_set.id)
  ...
  it "renders" do
    render "value_set_elements/toggle_value.rjs"
  end

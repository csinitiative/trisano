...
describe 'form builder place core field configs for places' do
  ...
  $fields = [
    {:name => 'Unit number', :label => 'place_event_address_attributes_unit_number', :entry_type => 'type', :fu_value => '444', :no_fu_value => '222'},
    {:name => 'City', :label => 'place_event_address_attributes_city', :entry_type => 'type', :fu_value => 'Brigham City', :no_fu_value => 'Provo'},
  ]                                    

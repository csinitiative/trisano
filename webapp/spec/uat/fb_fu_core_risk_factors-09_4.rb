...
describe 'form builder core risk factor followups for morbidity events' do
 ...
 $fields = [
   {:name => 'Risk factors', :label => 'morbidity_event_interested_party_attributes_risk_factor_attributes_risk_factors', :entry_type => 'type', :fu_value => get_unique_name(1), :no_fu_value => get_unique_name(1)}
  ]                                                  

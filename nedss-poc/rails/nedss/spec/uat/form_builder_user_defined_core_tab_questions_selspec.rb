...
describe 'form builder user-defined, core-tab questions' do
  ...
  it 'should create a new form with user-defined, core-tab questions' do
    ...
    add_question_to_view(@browser, DEMOGRAPHICS, @demo_question_text, "Single line text")
      
    add_core_tab_configuration(@browser, CLINICAL)
    add_question_to_view(@browser, CLINICAL, @clinical_question_text, "Single line text")
      
    add_core_tab_configuration(@browser, LABORATORY)
    add_question_to_view(@browser, LABORATORY, @laboratory_question_text, "Single line text")
      
    add_core_tab_configuration(@browser, CONTACTS)
    add_question_to_view(@browser, CONTACTS, @contacts_question_text, "Single line text")
      
    add_core_tab_configuration(@browser, EPI)
    add_question_to_view(@browser, EPI, @epi_question_text, "Single line text")
      
    add_core_tab_configuration(@browser, REPORTING)
    add_question_to_view(@browser, REPORTING, @reporting_question_text, "Single line text")
      
    add_core_tab_configuration(@browser, ADMIN)
    add_question_to_view(@browser, ADMIN, @admin_question_text, "Single line text")

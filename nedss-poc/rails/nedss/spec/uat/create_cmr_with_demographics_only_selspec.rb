...
describe 'Sytem functionality for setting the record ID of a CMR' do
  ...
  it 'should create a person with all the demographics information' do
    ...
    @browser.type('morbidity_event_active_patient__active_primary_entity__address_street_name', 'My Street')
    @browser.type('morbidity_event_active_patient__active_primary_entity__address_city', 'Hometown')
    @browser.select('morbidity_event_active_patient__active_primary_entity__address_state_id', 'label=Texas')
    @browser.select('morbidity_event_active_patient__active_primary_entity__address_county_id', 'label=Out-of-state')
    @browser.type('morbidity_event_active_patient__active_primary_entity__address_postal_code', '46060')
    @browser.type('morbidity_event_active_patient__active_primary_entity__person_birth_date', '4/1/1989')
    @browser.type('morbidity_event_active_patient__active_primary_entity__person_approximate_age_no_birthday', '34')
    @browser.type('morbidity_event_active_patient__active_primary_entity__telephone_area_code', '333')
    @browser.type('morbidity_event_active_patient__active_primary_entity__telephone_phone_number', '5551212')

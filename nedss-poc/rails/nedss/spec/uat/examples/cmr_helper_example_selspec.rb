...
describe "cmr helper example" do 
  ...
  it "should create a cmr from a hash of field names and values" do 
    @cmr_fields = {
      ...
      "event_active_patient__participations_treatment_treatment" => get_unique_name(1),
      #Clinician fields
      "event_clinician__active_secondary_entity__person_last_name" => get_unique_name(1),
      "event_clinician__active_secondary_entity__person_first_name" => get_unique_name(1),
      "event_clinician__active_secondary_entity__person_middle_name" => get_unique_name(1),
      "event_clinician__active_secondary_entity__address_street_number" => "456",
      "event_clinician__active_secondary_entity__address_street_name" => get_unique_name(1),
      "event_clinician__active_secondary_entity__address_unit_number" => "5141",
      "event_clinician__active_secondary_entity__address_city" => get_unique_name(1),
      ...
      #lab result fields -- Need to be updated
#      "event_lab_result_specimen_source_id" => "Blood",
#      "event_lab_result_tested_at_uphl_yn_id" => "Yes",
#      "event_lab_result_lab_result_text" => get_unique_name(1),
...
#      "event_lab_result_lab_test_date" => "1/1/1974",
      ...
      "event_contact__active_secondary_entity__person_last_name" => get_unique_name(1),
      "event_contact__active_secondary_entity__person_first_name" => get_unique_name(1),
      "event_contact__active_secondary_entity__person_middle_name" => get_unique_name(1),
      "event_contact__active_secondary_entity__address_street_number" => "7845",
      "event_contact__active_secondary_entity__address_street_name" => get_unique_name(1),
      "event_contact__active_secondary_entity__address_unit_number" => "7788",
      "event_contact__active_secondary_entity__address_city" => get_unique_name(1),
      ...
      "event_active_patient__participations_risk_factor_risk_factors" => get_unique_name(3),
      ...
      "event_active_reporter__active_secondary_entity__person_first_name" => get_unique_name(1),
      "event_active_reporter__active_secondary_entity__person_last_name" => get_unique_name(1),
      ...
      "model_auto_completer_tf" => get_unique_name(2), #This is the reporting agency field...

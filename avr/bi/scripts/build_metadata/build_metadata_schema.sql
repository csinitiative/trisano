...
(true,  'dw_morbidity_events_view',                  'Morbidity Events',                   'trisano.dw_morbidity_events_view',                     1, 'F', 'Morbidity', ''),
...
(true, 'dw_morbidity_repeaters_view',               'dw_morbidity_repeaters_view',        'trisano.dw_morbidity_repeaters_view',                  2, 'T', 'Morbidity', ''),
...
(true, 'dw_contact_repeaters_view',                 'dw_contact_repeaters_view',          'trisano.dw_contact_repeaters_view',                    4, 'T', 'Contact', ''),
(true,  'dw_assessment_events_view',                 'Assessment Events',                  'trisano.dw_assessment_events_view',                    7, 'F', 'Assessment', ''),
(true,  'dw_assessment_clinicians_view',             'Assessment Clinicians',              'trisano.dw_assessment_clinicians_view',                8, 'F', NULL, ''),
(true,  'dw_assessment_diagnostic_facilities_view',  'Assessment Diagnostic Facilities',   'trisano.dw_assessment_diagnostic_facilities_view',     8, 'F', NULL, ''),
(true,  'dw_assessment_email_addresses_view',        'Assessment Email Addresses',         'trisano.dw_assessment_email_addresses_view',           8, 'F', 'EmailAddress', 'JOIN trisano.participations_view ON (entity_id = primary_entity_id) JOIN trisano.dw_assessment_events_view q ON (q.id = event_id) '),
(true,  'dw_assessment_hospitals_view',              'Assessment Hospitals',               'trisano.dw_assessment_hospitals_view',                 8, 'F', 'Hospitalization', 'JOIN trisano.dw_assessment_events_view q ON (q.id = dw_assessment_events_id)'),
(true,  'dw_assessment_lab_results_view',            'Assessment Lab Results',             'trisano.dw_assessment_lab_results_view',               8, 'F', 'LabResults', 'JOIN trisano.dw_assessment_events_view q ON (q.id = dw_assessment_events_id)'), 
(true,  'dw_assessment_patients_races_view',         'Assessment Patients Races',          'trisano.dw_assessment_patients_races_view',            8, 'F', NULL, ''),
(true,  'dw_assessment_secondary_jurisdictions_view','Assessment Secondary Jurisdictions', 'trisano.dw_assessment_secondary_jurisdictions_view',   8, 'F', NULL, ''),
(true,  'dw_assessment_telephones_view',             'Assessment Telephone Numbers',       'trisano.dw_assessment_telephones_view',                8, 'F', 'Telephone', 'JOIN trisano.participations_view ON (entity_id = primary_entity_id) JOIN trisano.dw_assessment_events_view q ON (q.id = event_id) '),
(true,  'dw_assessment_treatments_events_view',      'Assessment Treatments Events',       'trisano.dw_assessment_treatments_events_view',         8, 'F', 'Treatment', 'JOIN trisano.dw_assessment_events_view q ON (q.id = dw_assessment_events_id)'),
(true, 'dw_assessment_repeaters_view',              'dw_assessment_repeaters_view',       'trisano.dw_assessment_repeaters_view',                 8, 'T', 'Assessment', ''),
...
(false, 'dw_encounter_repeaters_view',               'dw_encounter_repeaters_view',        'trisano.dw_encounter_repeaters_view',                  6, 'T', 'Encounter', ''),
(true,  'dw_place_events_view',                      'Place Events',                       'trisano.dw_place_events_view',                         9, 'F', 'Place', ''),
(false, 'dw_place_repeaters_view',                   'dw_place_repeaters_view',            'trisano.dw_place_repeaters_view',                     10, 'T', 'Place', ''),
(true,  'etl_success',                               'Data Sync Status',                   'trisano.etl_success',                                 11, 'F', NULL, ''),
(true,  'avr_groups_view',                           'Disease Groups',                     'trisano.avr_groups_view',                             11, 'F', NULL, ''),
(false, 'avr_groups_diseases_view',                  'avr_groups_diseases_view',           'trisano.avr_groups_diseases_view',                    11, 'F', NULL, '');
...
('trisano.dw_assessment_repeaters_view',               'dw_assessment_events_id',            'dw_assessment_events_id',            '',                          false),
('trisano.dw_assessment_repeaters_view',               'repeater_hstore',                    'repeater_hstore',                    '',                          false),
...
('trisano.dw_contact_repeaters_view',                 'dw_contact_events_id',               'dw_contact_events_id',               '',                          false),
('trisano.dw_contact_repeaters_view',                 'repeater_hstore',                    'repeater_hstore',                    '',                          false),
...
('trisano.dw_encounter_repeaters_view',               'dw_encounter_events_id',             'dw_encounter_events_id',             '',                          false),
('trisano.dw_encounter_repeaters_view',               'repeater_hstore',                    'repeater_hstore',                    '',                          false),
...
('trisano.dw_morbidity_repeaters_view',               'dw_morbidity_events_id',             'dw_morbidity_events_id',             '',                          false),
('trisano.dw_morbidity_repeaters_view',               'repeater_hstore',                    'repeater_hstore',                    '',                          false),
...
('trisano.dw_place_repeaters_view',                   'dw_place_events_id',                 'dw_place_events_id',                 '',                          false),
('trisano.dw_place_repeaters_view',                   'repeater_hstore',                    'repeater_hstore',                    '',                          false),
...
('dw_morbidity_events_view'         , 'id'                    , 'dw_morbidity_repeaters_view'               , 'dw_morbidity_events_id' , '0:N', 'An'),
...
('dw_assessment_events_view'         , 'id'                    , 'dw_assessment_repeaters_view'             , 'dw_assessment_events_id' , '0:N', 'An'),
...
('dw_contact_events_view'           , 'id'                    , 'dw_contact_repeaters_view'                 , 'dw_contact_events_id'   , '0:N', 'Bj'),
...
('dw_encounter_events_view'         , 'id'                    , 'dw_encounter_repeaters_view'               , 'dw_encounter_events_id' , '0:N', 'Cf'),

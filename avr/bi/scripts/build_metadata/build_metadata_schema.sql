...
(true,  'dw_morbidity_hospitals_view',               'Morbidity Hospitals',                'trisano.dw_morbidity_hospitals_view',                  2, 'Hospitalization', 'JOIN trisano.dw_morbidity_events_view q ON (q.id = dw_morbidity_events_id)'),
(true,  'dw_morbidity_lab_results_view',             'Morbidity Lab Results',              'trisano.dw_morbidity_lab_results_view',                2, 'LabResults', 'JOIN trisano.dw_morbidity_events_view q ON (q.id = dw_morbidity_events_id)'),
...
(true,  'dw_morbidity_treatments_events_view',       'Morbidity Treatments Events',        'trisano.dw_morbidity_treatments_events_view',          2, 'Treatment', 'JOIN trisano.dw_morbidity_events_view q ON (q.id = dw_morbidity_events_id)'),
...
(true,  'dw_contact_hospitals_view',                 'Contact Hospitals',                  'trisano.dw_contact_hospitals_view',                    4, 'Hospitalization', 'JOIN trisano.dw_contact_events_view q ON (q.id = dw_contact_events_id)'),
(true,  'dw_contact_lab_results_view',               'Contact Lab Results',                'trisano.dw_contact_lab_results_view',                  4, 'LabResults', 'JOIN trisano.dw_contact_events_view q ON (q.id = dw_contact_events_id)'),
...
(true,  'dw_contact_treatments_events_view',         'Contact Treatments Events',          'trisano.dw_contact_treatments_events_view',            4, 'Treatment', 'JOIN trisano.dw_contact_events_view q ON (q.id = dw_contact_events_id)'),
...
(true,  'dw_assessment_hospitals_view',              'Assessment Hospitals',               'trisano.dw_assessment_hospitals_view',                 2, 'Hospitalization', 'JOIN trisano.dw_assessment_events_view q ON (q.id = dw_assessment_events_id)'),
(true,  'dw_assessment_lab_results_view',            'Assessment Lab Results',             'trisano.dw_assessment_lab_results_view',               2, 'LabResults', 'JOIN trisano.dw_assessment_events_view q ON (q.id = dw_assessment_events_id)'), 
...
(true,  'dw_assessment_treatments_events_view',      'Assessment Treatments Events',       'trisano.dw_assessment_treatments_events_view',         2, 'Treatment', 'JOIN trisano.dw_assessment_events_view q ON (q.id = dw_assessment_events_id)'),
...
(true,  'dw_encounters_treatments_events_view',      'Encounters Treatments Events',       'trisano.dw_encounters_treatments_events_view',         6, 'Treatment', 'JOIN trisano.dw_encounter_events_view q ON (q.id = dw_encounter_events_id)'),
